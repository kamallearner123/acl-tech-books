...
function initSearchModal() {
    ...
    const courseIndex = [
        ...
        { day: "ref6", title: "Ref 6: Complete Firmware Lifecycle (Requirements to Deployment)", url: "ref_lifecycle.html", tags: "reference lifecycle requirements srs architecture vmodel misra unit test cmock unity linker script elf hex bin signing secure boot factory flashing rdp fota ota deployment", desc: "End-to-end engineering workflow: SRS requirements, layered architecture, MISRA-C, host unit testing, linker scripts, signing, factory flashing, and FOTA field updates." },
